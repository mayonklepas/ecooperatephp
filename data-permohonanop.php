...
if(isset($_POST['simpan'])){
  ...
  if($sid == ""){
    ...
    echo "<script>alert('Data Berhasil Diinput'); window.location.replace('data-permohonan.php');</script>";
  }else{
    ...
    echo "<script>alert('Data Berhasil Diupdate'); window.location.replace('data-permohonan.php');</script>";
  }
...
<div class="page-inner">
    <div class="page-breadcrumb">
        <ol class="breadcrumb container">
            ...
            <li><a href="data-kegiatan.php">Data Permohonan</a></li>
            <li class="active">Input Data Permohonan</li>
        </ol>
    </div>
    <div class="page-title">
        <div class="container">
            <h3>Input Data Permohonan</h3>
        </div>
    </div>
            ...
            <div class="col-md-8">
                <div class="panel panel-white">
                    <div class="panel-heading clearfix">
                        <h4 class="panel-title">Input Data Permohonan</h4>
                    </div>
                    <div class="panel-body">
      <br>
        <form class="" action="" method="post">
          <label for="">NIP</label>
          <input type="text" name="nip" value="<?php echo $snip;?>" class="form-control" required=required list="daftar-pegawai" autocomplete="off">
          <datalist class="" id="daftar-pegawai">
            <?php foreach ($datapegawai as $value): ?>
              <option value="<?php echo $value['nip'] ?>"><?php echo $value['nama_pegawai'] ?></option>
            <?php endforeach; ?>
          </datalist>
