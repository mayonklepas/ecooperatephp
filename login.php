...
if(isset($_POST['login'])){
  ...
  $datalogin=$h->read("SELECT COUNT(nik) AS jumlah, nama, jabatan, email, telepon, password, nik, nip, tipe FROM data_pemohon WHERE nip=? AND password=? LIMIT 1",array($username,$password));
