            ...
            <div class="page-sidebar sidebar">
                <div class="page-sidebar-inner slimscroll">
                        ...
                        <div class="sidebar-profile">
                            <a href="javascript:void(0);" id="profile-menu-link">
                                ...
                                <div class="sidebar-profile-details">
                                    <span><?php echo $_SESSION['nama'] ?><br><small><?php echo $_SESSION['jabatan'] ?></small></span>
                                </div>
                            </a>
                        </div>
                    </div>
                    <ul class="menu accordion-menu">
                        ...
                        <li class="droplink"><a href="#" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-list"></span><p>Master Data</p><span class="arrow"></span></a>
                            <ul class="sub-menu">
                        ...
                        <li class="droplink"><a href="#" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-list"></span><p>Data Kerjasama</p><span class="arrow"></span></a>
                            <ul class="sub-menu">
                                <li><a href="data-pemohon.php">Kerjasama Dalam Negeri</a></li>
                                <li><a href="data-mitra.php">Kerjasama Luar Negeri</a></li>
                            </ul>
                        </li>
                        <li><a href="data-kegiatan.php" class="waves-effect waves-button"><span class="menu-icon glyphicon glyphicon-list"></span><p>Data Kegiatan</p></a></li>
                    </ul>
